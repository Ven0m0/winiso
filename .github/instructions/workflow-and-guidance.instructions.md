...
applyTo: ".github/workflows/*.{yml,yaml},AGENTS.md,CLAUDE.md,.github/copilot-instructions.md,.github/instructions/**/*.md,.github/skills/**/*.md,CHANGELOG.md,mise.toml,.pre-commit-config.yaml"
---
