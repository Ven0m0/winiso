...
- [x] move `.mise/tasks/` into `mise.toml`
- [x] keep `scripts/files/setup_post_install.py` as cmd since that will be injected into an iso file to be automatically executed from the oemsetup folder. Merge it as cmd into `config/oem/SetupComplete.cmd`
