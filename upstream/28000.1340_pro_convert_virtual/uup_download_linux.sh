...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=3d01a661-1c2c-4c2b-8e79-12c85e8e9b30&pack=en-us&edition=professional&aria2=2"
if [ $? != 0 ]; then
